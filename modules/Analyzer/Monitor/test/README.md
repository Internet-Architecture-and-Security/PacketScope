...
- Check if `ipv4packets` table exists in `tcxprober` database
- Check if `ipv6packets` table exists in `tcxprober` database
- Check if `otherpackets` table exists in `tcxprober` database
...
- Validate column names and data types for `ipv4packets` table (14 columns)
- Validate column names and data types for `ipv6packets` table (10 columns)
- Validate column names and data types for `otherpackets` table (5 columns)

### Data Status
- Verify data count retrieval for all tables
- Check sample data from all tables
- Check sample data from `ipv4packets`, `ipv6packets`, and `otherpackets` tables
