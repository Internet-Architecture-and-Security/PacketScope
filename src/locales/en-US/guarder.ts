const Guarder = {
  ...
  'Guarder.aiAnalysisConfigDesc':
    'Select analysis type and data scope. AI will generate intelligent filter rules based on current network status.',
  ...
  // ── New: PCAP File Intelligence Analysis ──────────────────────────
  'AiCenter.pcap.modalTitle': 'PCAP File Intelligence Analysis',
  'AiCenter.pcap.alertTitle': 'PCAP File Intelligence Analysis',
  'AiCenter.pcap.alertDesc': 'Upload a .pcap or .pcapng file. AI will automatically parse traffic and identify security threats and anomalies. Max 32MB, up to 5000 packets.',
  'AiCenter.pcap.uploadLabel': 'Select PCAP File',
  'AiCenter.pcap.uploadDragText': 'Click or drag a PCAP file here',
  'AiCenter.pcap.uploadHint': 'Supports .pcap / .pcapng, max 32MB',
  'AiCenter.pcap.fileSize': 'File size: {size} MB',
  'AiCenter.pcap.invalidFileType': 'Only .pcap / .pcapng files are supported',
  'AiCenter.pcap.fileTooLarge': 'File size must not exceed 32MB',
  'AiCenter.pcap.noFile': 'Please select a PCAP file first',
  'AiCenter.pcap.analyzeTypeLabel': 'Analysis Strategy',
  'AiCenter.pcap.analyzeTypeRequired': 'Please select an analysis strategy',
  'AiCenter.pcap.typeSecurity': 'Security Analysis',
  'AiCenter.pcap.typePerformance': 'Performance Analysis',
  'AiCenter.pcap.typeCustom': 'Custom',
  'AiCenter.pcap.customPromptRequired': 'Please enter a custom prompt',
  'AiCenter.pcap.customPromptPlaceholder': 'e.g. Focus on identifying C2 communication, DNS tunneling, or lateral movement…',
  'AiCenter.pcap.startAnalysis': 'Start AI Analysis',
  'AiCenter.pcap.reAnalyze': 'Re-analyze',
  'AiCenter.pcap.done': 'Done',
  'AiCenter.pcap.step1Title': 'Upload File',
  'AiCenter.pcap.step1Desc': 'Select PCAP file',
  'AiCenter.pcap.step2Title': 'AI Parsing',
  'AiCenter.pcap.step2Desc': 'Parsing packet traffic',
  'AiCenter.pcap.step3Title': 'Generate Report',
  'AiCenter.pcap.step3Desc': 'Output analysis results',
  'AiCenter.pcap.analysisComplete': 'PCAP Analysis Complete',
  'AiCenter.pcap.analysisFailed': 'PCAP Analysis Failed',
  'AiCenter.pcap.errorTitle': 'Analysis Error',
  'AiCenter.pcap.resultAlertTitle': 'PCAP Analysis Complete',
  'AiCenter.pcap.resultAlertDesc': '{count} threat(s) detected. Full analysis report generated.',
  'AiCenter.pcap.tabSummary': '📋 Summary',
  'AiCenter.pcap.tabThreats': '🚨 Threats',
  'AiCenter.pcap.tabStats': '📊 Statistics',
  'AiCenter.pcap.tabSuggestions': '💡 Suggestions',
  'AiCenter.pcap.noSummary': '(No summary)',
  'AiCenter.pcap.noThreats': 'No threats detected',
  'AiCenter.pcap.noStats': 'No statistics available',
  'AiCenter.pcap.noSuggestions': 'No suggestions',
};
...
const FiltersManager = {
  ...
  'FiltersManager.udpRuleDescription':
    'UDP rules mainly use source and destination ports for filtering, no additional specific field configuration is required.',
  'FiltersManager.ruleDescription': 'Rule Description',
  'FiltersManager.ruleDescriptionPlaceholder':
    'Enter rule description, it is recommended to describe the purpose and effective conditions of the rule in detail',
...
const AiCenter = {
  ...
  'AiCenter.aiServiceConfiguredDesc': 'Provider: {provider} | Model: {model} | Endpoint: {endpoint}',
  ...
  'AiCenter.aiConfigDesc': 'Configure OpenAI-compatible or Anthropic-compatible API access for AI analysis and rule generation',
  ...
  'AiCenter.networkAnalysis': 'PCAP Intelligence Analysis',
  'AiCenter.networkAnalysisDesc': 'Upload PCAP files for AI-powered traffic parsing and threat detection',
  'AiCenter.threatDetection': 'Threat Detection',
  'AiCenter.trafficAnalysis': 'Traffic Parsing',
  ...
  'AiCenter.feature4': 'Flexible OpenAI-compatible and Anthropic-compatible endpoint configuration',
  ...
  'AiCenter.configDescriptionText':
    'Choose an AI provider protocol, then configure the endpoint, API key and model. These settings are used for AI analysis and rule generation.',
  'AiCenter.provider': 'Provider Protocol',
  'AiCenter.providerOpenAI': 'OpenAI Compatible',
  'AiCenter.providerAnthropic': 'Anthropic Compatible',
  'AiCenter.providerOpenAIShort': 'OpenAI',
  'AiCenter.providerAnthropicShort': 'Anthropic',
  'AiCenter.endpoint': 'API Endpoint',
  'AiCenter.apiKey': 'API Key',
  'AiCenter.model': 'Model',
  'AiCenter.temperature': 'Temperature',
  'AiCenter.timeout': 'Timeout (seconds)',
  'AiCenter.anthropicVersion': 'Anthropic Version',
  'AiCenter.enableDebugMode': 'Enable Debug Mode',

  // 表单验证消息
  'AiCenter.pleaseSelectProvider': 'Please select provider protocol',
  'AiCenter.pleaseEnterEndpoint': 'Please enter API endpoint',
  ...
  'AiCenter.pleaseEnterAnthropicVersion': 'Please enter Anthropic version',
  ...
  'AiCenter.analysisDescriptionText':
    'This feature only analyzes current network traffic patterns and threat conditions, and will not generate filter rules. Suitable for understanding network security status.',
  ...
  'AiCenter.customAnalysisPlaceholder':
    "Optional: Provide specific analysis instructions, such as 'analyze abnormal behavior in traffic patterns'...",
  ...
  'AiCenter.aiServiceNotConfiguredContent':
    'Please configure AI service parameters first before using intelligent analysis features. Configure now?',
