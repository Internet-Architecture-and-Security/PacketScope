...
const AiCenter = {
  ...
  'AiCenter.aiServiceConfiguredDesc': '协议: {provider} | 模型: {model} | 端点: {endpoint}',
  ...
  'AiCenter.aiConfigDesc': '配置 OpenAI 兼容或 Anthropic 兼容的 AI 接入参数，用于分析和规则生成',
  ...
  'AiCenter.networkAnalysis': 'PCAP 智能分析',
  'AiCenter.networkAnalysisDesc': '上传 PCAP 文件，AI 自动解析流量并识别安全威胁',
  'AiCenter.threatDetection': '威胁识别',
  'AiCenter.trafficAnalysis': '流量解析',
  ...
  'AiCenter.feature4': '灵活支持 OpenAI 兼容与 Anthropic 兼容端点配置',
  ...
  'AiCenter.configDescriptionText': '请选择 AI 协议类型，并配置端点、API 密钥和模型。这些信息将用于 AI 分析和规则生成。',
  'AiCenter.provider': '协议类型',
  'AiCenter.providerOpenAI': 'OpenAI 兼容',
  'AiCenter.providerAnthropic': 'Anthropic 兼容',
  'AiCenter.providerOpenAIShort': 'OpenAI',
  'AiCenter.providerAnthropicShort': 'Anthropic',
  'AiCenter.endpoint': 'API端点',
  'AiCenter.apiKey': 'API密钥',
  'AiCenter.model': '模型',
  'AiCenter.temperature': 'Temperature',
  'AiCenter.timeout': '超时时间(秒)',
  'AiCenter.anthropicVersion': 'Anthropic 版本',
  'AiCenter.enableDebugMode': '启用调试模式',

  // 表单验证消息
  'AiCenter.pleaseSelectProvider': '请选择协议类型',
  'AiCenter.pleaseEnterEndpoint': '请输入 API 端点',
  ...
  'AiCenter.pleaseEnterAnthropicVersion': '请输入 Anthropic 版本',
  ...
  // ── 新增：PCAP 文件智能分析 ───────────────────────────────────────
  'AiCenter.pcap.modalTitle': 'PCAP 文件智能分析',
  'AiCenter.pcap.alertTitle': 'PCAP 文件智能分析',
  'AiCenter.pcap.alertDesc': '上传 .pcap 或 .pcapng 文件，AI 将自动解析流量并识别安全威胁、异常行为等。支持最大 32MB，最多处理 5000 个数据包。',
  'AiCenter.pcap.uploadLabel': '选择 PCAP 文件',
  'AiCenter.pcap.uploadDragText': '点击或拖拽 PCAP 文件到此区域',
  'AiCenter.pcap.uploadHint': '支持 .pcap / .pcapng，最大 32MB',
  'AiCenter.pcap.fileSize': '文件大小：{size} MB',
  'AiCenter.pcap.invalidFileType': '仅支持 .pcap / .pcapng 文件',
  'AiCenter.pcap.fileTooLarge': '文件大小不能超过 32MB',
  'AiCenter.pcap.noFile': '请先选择 PCAP 文件',
  'AiCenter.pcap.analyzeTypeLabel': '分析策略',
  'AiCenter.pcap.analyzeTypeRequired': '请选择分析策略',
  'AiCenter.pcap.typeSecurity': '安全分析',
  'AiCenter.pcap.typePerformance': '性能分析',
  'AiCenter.pcap.typeCustom': '自定义',
  'AiCenter.pcap.customPromptRequired': '请输入自定义提示词',
  'AiCenter.pcap.customPromptPlaceholder': '例如：重点识别 C2 通信、DNS 隧道或横向移动行为…',
  'AiCenter.pcap.startAnalysis': '开始 AI 分析',
  'AiCenter.pcap.reAnalyze': '重新分析',
  'AiCenter.pcap.done': '完成',
  'AiCenter.pcap.step1Title': '上传文件',
  'AiCenter.pcap.step1Desc': '选择 PCAP 文件',
  'AiCenter.pcap.step2Title': 'AI 解析',
  'AiCenter.pcap.step2Desc': '解析数据包流量',
  'AiCenter.pcap.step3Title': '生成报告',
  'AiCenter.pcap.step3Desc': '输出分析结果',
  'AiCenter.pcap.analysisComplete': 'PCAP 分析完成',
  'AiCenter.pcap.analysisFailed': 'PCAP 分析失败',
  'AiCenter.pcap.errorTitle': '分析出错',
  'AiCenter.pcap.resultAlertTitle': 'PCAP 分析完成',
  'AiCenter.pcap.resultAlertDesc': '共检测到 {count} 个威胁，已生成完整分析报告。',
  'AiCenter.pcap.tabSummary': '📋 分析摘要',
  'AiCenter.pcap.tabThreats': '🚨 威胁列表',
  'AiCenter.pcap.tabStats': '📊 流量统计',
  'AiCenter.pcap.tabSuggestions': '💡 安全建议',
  'AiCenter.pcap.noSummary': '（无摘要）',
  'AiCenter.pcap.noThreats': '未检测到威胁',
  'AiCenter.pcap.noStats': '暂无统计数据',
  'AiCenter.pcap.noSuggestions': '暂无建议',
};
